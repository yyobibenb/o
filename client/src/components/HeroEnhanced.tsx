        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="font-sans text-base">
              Follow these simple steps to get your wrong Bitcoin
            </DialogDescription>
          </DialogHeader>
          
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <h4 className="font-serif text-sm font-bold">STEP 1: GET A WALLET</h4>
              <p className="text-sm text-muted-foreground">
                Download MetaMask or any Web3 wallet
              </p>
            </div>

            <div className="space-y-2">
              <h4 className="font-serif text-sm font-bold">STEP 2: ADD ETH</h4>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-2">
              <h4 className="font-serif text-sm font-bold">STEP 3: SWAP FOR $BTC</h4>
              <p className="text-sm text-muted-foreground">
                Use Uniswap or any DEX to swap ETH for $BTC
              </p>
            </div>

            <div className="space-y-2">
              <h4 className="font-serif text-sm font-bold">CONTRACT ADDRESS</h4>
              <div className="flex items-center gap-2">
                <code className="flex-1 p-2 bg-muted rounded text-xs overflow-hidden text-ellipsis">
                  {contractAddress}
                </code>
                <Button
                  size="icon"
          ...
          <div className="flex flex-col gap-2">
            <Button
              ...
              data-testid="button-open-uniswap"
            >
